...
import SUai.TWEANNGenotype.LinkGene;
...
//		NETWORK_VIEW_DIM = (Parameters.parameters.booleanParameter("hyperNEAT")) ? Parameters.parameters.integerParameter("hyperNEATNetworkDisplaySize") : 500;
		...
		this.hierarchicalMultitask = false; //CommonConstants.hierarchicalMultitask;
...
//			}
			...
			// determine winner
			chosenModule = 0;//CommonConstants.softmaxModeSelection 
