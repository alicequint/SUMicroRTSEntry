...
public class NetworkUtil {
	...
	public static final double linkExpressionThreshold = 0.2;
	...
	public static double calculateWeight(double originalOutput) {
		assert(false || Math.abs(originalOutput) > linkExpressionThreshold) : "This link should not be expressed: " + originalOutput;
		if (originalOutput > linkExpressionThreshold) {
			return originalOutput - linkExpressionThreshold;
		} else {
			return originalOutput + linkExpressionThreshold;
		}
	}
